...
public class ReservaDAO {
    ...
    public boolean create(Reserva reserva) {
        ...
        try (PreparedStatement stmp = connection.prepareStatement(sql)) {
            ...
            stmp.setTimestamp(5, new java.sql.Timestamp(reserva.getFechaCheckin().getTime()));
            stmp.setTimestamp(6, new java.sql.Timestamp(reserva.getFechaCheckout().getTime()));
    ...
    private Reserva mapReserva(ResultSet rs) throws Exception {
        ...
        reserva.setFechaCheckin(rs.getTimestamp("fecha_checkin"));
        reserva.setFechaCheckout(rs.getTimestamp("fecha_checkout"));
